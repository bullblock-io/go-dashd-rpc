...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []btcutil.Address, account string) (string, error) {
...
func (c *Client) GetRawChangeAddress(account string) (string, error) {
